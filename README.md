# Дипломная работа по автоматизации тестирования портала [Битрикс.24](https://www.bitrix24.ru/) - мобильное приложение
...
<a id="jenkins"></a>
## 🌿 [Сборка в Jenkins](https://jenkins.autotests.cloud/job/qa_guru_diploma_anastasnanas_mobile/)
...
<a id="allure"></a>
## 🌿 [Allure отчет](https://jenkins.autotests.cloud/job/qa_guru_diploma_anastasnanas_mobile/42/allure/)
...
<a id="testops"></a>
## [Allure TestOps](https://allure.autotests.cloud/launch/49858/tree/750881?search=W3siaWQiOiJzdGF0dXMiLCJ0eXBlIjoidGVzdFN0YXR1c0FycmF5IiwidmFsdWUiOlsicGFzc2VkIl19XQ%3D%3D&treeId=0)
...
- Помимо автотестов, в Allure TestOps могут храниться и ручные тест кейсы.
